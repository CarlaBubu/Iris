...
public class EditarPerfilActivity extends AppCompatActivity {
    ...
    private EditText senhaEditText; // Campo para a nova senha
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        senhaEditText = findViewById(R.id.editText_senha4); // Referência ao campo de senha
        imageViewIcon = findViewById(R.id.imageView_icon2);
        buttonSalvarPerfil = findViewById(R.id.button_salvar_edicao);
        buttonFecharPerfil = findViewById(R.id.button_voltar_editarPerfil);
        buttonExcluir = findViewById(R.id.button_excluir); // Referência ao botão de excluir
    ...
    private void salvarPerfil() {
        ...
        String novaSenha = senhaEditText.getText().toString(); // Obtém a nova senha do campo

        if (imageUri != null) {
            uploadImageToFirebase(novaSenha); // Passa a nova senha para o upload da imagem
        } else {
            atualizarPerfil(novaSenha); // Atualiza o perfil e a senha
        }
    }
